import"./assets/mobMenu-2024c496.js";import{a as r,N as S}from"./assets/vendor-77e6b4aa.js";r.defaults.baseURL="https://books-backend.p.goit.global/";async function k(){return(await r.get("/books/category-list")).data}async function g(){return(await r.get("/books/top-books")).data}async function f(t){return(await r.get(`/books/category?category=${t}`)).data}async function C(t){return(await r.get(`/books/${t}`)).data}g();function E(t,e){const o=e===0?"mobile-visible":"",n=e<3?"tablet-visible":"",s=e<5?"desktop-visible":"";return`
